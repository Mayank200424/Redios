...
<body>
                         ...
                         <div class="col-xl-12">
                              <div class="card">
                                   <div class="card-header d-flex justify-content-between align-items-center gap-1">
                                        ...
                                        <div>
                                             <form class="app-search d-none d-md-block ms-2" method="GET"
     ...
     <script>
          ...
          deleteModal.addEventListener('show.bs.modal', function (event) {
               ...
               form.action = "/vendor/product/delete/" + id;
          });
                                   ...
                                   if (data.data.length > 0) {
                                        ...
                                        data.data.forEach(function (product) {
                                             ...
                                             <tr>
                                                  ...
                                                  <td>${product.id}</td>
                                                  <td><img src="/storage/${product.image}" style="width:80px;height:80px;"></td>
                                                  <td>${product.name}</td>
                                                  <td>${product.price}</td>
                                                  <td>${product.stock}</td>
