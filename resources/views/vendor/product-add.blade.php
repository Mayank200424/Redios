                                        ...
                                        <form action="{{ route('product.create') }}" method="post"
                                             ...
                                             <div class="row">
                                                  ...
                                                  <div class="col-md-12 mb-3">
                                                       ...
                                                       <div>
                                                            <span
                                                                 style="color: red;">@error('image'){{ $message }}@enderror</span>
                                                       </div>
                                                  </div>
                                                  ...
                                                  <div class="col-md-6 mb-3">
                                                       ...
                                                       <div>
                                                            <span
                                                                 style="color: red;">@error('name'){{ $message }}@enderror</span>
                                                       </div>
                                                  </div>
                                                  ...
                                                  <div class="col-md-6 mb-3">
                                                       ...
                                                       <div>
                                                            <span
                                                                 style="color: red;">@error('category_id'){{ $message }}@enderror</span>
                                                       </div>
                                                  </div>
                                                  ...
                                                  <div class="col-md-6 mb-3">
                                                       ...
                                                       <div>
                                                            <span
                                                                 style="color: red;">@error('stock'){{ $message }}@enderror</span>
                                                       </div>
                                                  </div>
                                                  ...
                                                  <div class="col-md-6 mb-3">
                                                       ...
                                                       <div>
                                                            <span
                                                                 style="color: red;">@error('price'){{ $message }}@enderror</span>
                                                       </div>
                                                  </div>
