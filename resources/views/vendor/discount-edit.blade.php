               ...
               <div class="container-fluid">
                    <div class="navbar-header">
                         <div class="d-flex align-items-center">
                              ...
                              <!-- Menu Toggle Button -->
                              <div class="topbar-item">
                                   <h4 class="fw-bold topbar-button pe-none text-uppercase mb-0">Edit Discount</h4>
                              </div>
                         </div>
                                             ...
                                             <div class="row">
                                                  ...
                                                  <div class="col-md-6 mb-3">
                                                       ...
                                                       <select class="form-select" name="product_id" required>
                                                            ...
                                                            @foreach ($products as $product)
                                                                 <option value="{{ $product->id }}" {{ (old('product_id', $discounts->product_id) == $product->id) ? 'selected' : '' }}>
                                                                      {{ $product->name }}
                                                                 </option>
                                                            @endforeach
                                                       </select>
                                                  ...
                                                  <div class="col-md-6 mb-3">
                                                       ...
                                                       <input type="number" step="0.01" class="form-control" min="0"
                                                            ...
                                                            value="{{ old('discount_value', $discounts->discount_value) }}">
                                                  </div>
                                                  ...
                                                  <div class="col-md-6 mb-3">
                                                       ...
                                                       <input type="date" class="form-control" name="start_date"
                                                            value="{{ old('start_date', $discounts->start_date) }}">
                                                  </div>

                                                  <!-- End Date -->
                                                  <div class="col-md-6 mb-3">
                                                       <label class="form-label">End Date</label>
                                                       <input type="date" class="form-control" name="end_date" value="{{ old('end_date', $discounts->end_date) }}">
                                                  </div>
                                                  ...
                                                  <div class="col-md-6 mb-3">
                                                       ...
                                                       <select class="form-select" name="status" required>
                                                            ...
                                                            <option value="active" {{ (old('status', $discounts->status) == 'active') ? 'selected' : '' }}>Active</option>
                                                            <option value="inactive" {{ (old('status', $discounts->status) == 'inactive') ? 'selected' : '' }}>Inactive</option>
                                                            <option value="expired" {{ (old('status', $discounts->status) == 'expired') ? 'selected' : '' }}>Expired</option>
                                                       </select>
                                                  </div>
