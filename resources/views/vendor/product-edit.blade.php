               ...
               <div class="container-fluid">
                    <div class="navbar-header">
                         <div class="d-flex align-items-center">
                              ...
                              <!-- Menu Toggle Button -->
                              <div class="topbar-item">
                                   <h4 class="fw-bold topbar-button pe-none text-uppercase mb-0">Edit Product</h4>
                              </div>
                         </div>
                                        ...
                                        <form action="{{ route('product.update',$product->id) }}" method="post" enctype="multipart/form-data">
                                             ...
                                             <div class="row">
                                                  <div class="mb-3">
                                                       ...
                                                       <br>
                                                       <td><img src="{{ asset('storage/' .$product->image) }}" style="height:80px; width:80px;"></td>
                                                  </div>
                                                  <!-- Product Image -->
                                                  ...
                                                  <div class="col-md-6 mb-3">
                                                       ...
                                                       <input type="number" class="form-control" name="stock" placeholder="Quantity" min="0"   value="{{ $product->stock }}">
                                                  </div>
