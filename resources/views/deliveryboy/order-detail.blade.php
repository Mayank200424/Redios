                         ...
                         <div class="col-lg-8">
                                   ...
                                   <div class="card-body d-flex justify-content-between align-items-center">
                                        <div>
                                             <h4 class="fw-bold mb-1">
                                                  Order Number : {{ $order->orderItem->order->order_number }}
                                             </h4>
                                             <p class="text-muted mb-0">
                                                  Order Date : {{ $order->orderItem->order->created_at->format('d-m-Y') }}
                                             </p>
                                        </div>
                                   </div>
                              </div>
                                             ...
                                             @switch($order->orderItem->order_status)
                                                  ...
                                                  @case('out_of_delivery')
                                                       <span style="background: #9c27b0; color: white; padding:4px 8px; border-radius:4px; display:inline-block;">
                                                            {{ ucfirst(str_replace('_',' ',$order->orderItem->order_status)) }}
                                                       </span>
                                                  @break
                              ...
                              <div class="card mb-3">
                                   ...
                                   <div class="card-body">
                                        ...
                                        <p><strong>Name:</strong> {{ $order->orderItem->users->name }}</p>
                                        <p><strong>Email:</strong> {{ $order->orderItem->users->email }}</p>
                                        <p><strong>Phone:</strong> {{ $order->orderItem->order->address->phone }}</p>

                                        <hr>

                                        <h6 class="fw-bold">Shipping Address</h6>
                                        <p class="mb-1">{{ $order->orderItem->order->address->address }}</p>

                                        <p class="mb-1">
                                        <h6 class="fw-bold">City</h6>
                                        {{ $order->orderItem->order->address->city }},
                                        <p class="mb-1">
                                        <h6 class="fw-bold">State</h6>
                                        {{ $order->orderItem->order->address->state }}
                                        </p>
                                        </p>
                                        ...
                                        <div class="table-responsive">
                                             <table class="table table-bordered align-middle">
                                                  ...
                                                  <tbody>
                                                       <tr>
                                                            <td width="80">
                                                                 <img src="{{ asset('storage/' . $order->orderItem->product->image) }}"
                                                                      class="img-fluid rounded" width="60">
                                                            </td>
                                                            <td>{{ $order->orderItem->product->name }}</td>
                                                            <td>{{ $order->orderItem->product->category->name }}</td>
                                                            <td>{{ $order->orderItem->quantity ?? 1 }}</td>
                              ...
                              <div class="card">
                                   ...
                                   <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between mb-2">
                                             <span>GST (18%)</span>
                                             <span>
                                                  ₹{{ number_format(($order->orderItem->price * 18) / 100, 2) }}
                                             </span>
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-between fw-bold fs-5">
                                             ...
                                             <span>₹{{ $order->orderItem->total_amount }}</span>
                                        </div>
                              ...
                              <div class="card">
                                   ...
                                   <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between mb-2">
                                             ...
                                             <span>{{ $order->orderItem->vendor->name }}</span>
                                        </div>

                                        <div class="d-flex justify-content-between mb-2">
                                             <h5 class="fw-bold">Email</h5>
                                             <span>
                                                  {{ $order->orderItem->vendor->email }}
                                             </span>
                                        </div>
