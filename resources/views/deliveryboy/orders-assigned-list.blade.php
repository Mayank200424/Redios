...
<body>
               ...
               <div class="container-fluid">
                    <div class="navbar-header">
                         <div class="d-flex align-items-center">
                              ...
                              <!-- Menu Toggle Button -->
                              <div class="topbar-item">
                                   <h4 class="fw-bold topbar-button pe-none text-uppercase mb-0">Orders Assigned List</h4>
                              </div>
                         </div>
                              ...
                              <div class="col-xl-12">
                                   <div class="card">
                                        <div class="d-flex card-header justify-content-between align-items-center">
                                             <div>
                                                  <h4 class="card-title">Assigned Order List</h4>
                                             </div>
                                        </div>
     ...
     <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
               ...
               <form action="{{ route('deliveryboy.update-order-status', $order->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="modal-body">
                         ...
                         <input type="text" class="form-control"
                              value="{{ $order->orderItem->order->order_number }}" readonly>
                         </div>
                         ...
                         <input type="text" class="form-control"
                              value="{{ ucfirst($order->orderItem->order_status) }}" readonly>
                         </div>
                         ...
                         <select name="order_status" class="form-select" required>
                              ...
                              <option value="out_of_delivery" {{ $order->order_status == 'out_of_delivery' ? 'selected' : '' }}>
                                   Out Of Delivery
                              </option>
