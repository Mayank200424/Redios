...
<!-- Mirrored from techzaa.in/larkon/admin/customer-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Feb 2026 10:40:25 GMT -->
                         ...
                         <div class="col-xl-12">
                              <div class="card">
                                   <div class="d-flex card-header justify-content-between align-items-center">
                                        <div>
                                             <h4 class="card-title">All DeliveryBoy List</h4>
                                        </div>
                                        <div>
                                             <!-- App Search-->
                                             <form class="app-search d-none d-md-block ms-2">
                                                  <div class="position-relative">
                                                       <input type="search" class="form-control search-input"
                                                            placeholder="Search deliveryboys" name="search"
     ...
     <div class="modal fade" id="viewModal">
          <div class="modal-dialog modal-dialog-centered">
               <div class="modal-content">
                    ...
                    <div class="modal-header">
                         <h5 class="modal-title">DeliveryBoy Details</h5>
                    ...
                    <div class="modal-body">
                         ...
                         <div class="mb-3">
                              ...
                              <p id="viewRole" class="mb-0 text-muted"></p>
                         </div>
                    ...
                    $.ajax({
                         ...
                         success: function (data) {
                              ...
                              if (data.length > 0) {
                                   ...
                                   data.forEach(function (deliveryboy) {
                                        html += `
                                             <tr>
                                                  <td>
                                                       <div class="form-check">
                                                  ...
                                                  <td>${deliveryboy.email}</td>
                                                  <td>${deliveryboy.role}</td>
                                                  <td>${deliveryboy.created_at ? new Date(deliveryboy.created_at).toLocaleDateString('en-GB') : 'N/A'}</td>
                                                  <td>
                                                       <div class="d-flex gap-2">
                                                            <a href="javascript:void(0)"
                                                                 class="btn btn-light btn-sm viewCustomerBtn"
