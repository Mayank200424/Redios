                    ...
                    <div class="container-xxl">
                         ...
                         <div class="row gx-4">  
                              <div class="col-md-6 col-xl-3">
                                   <a href="{{ route('order-list') }}" style="text-decoration: none;">
                              ...
                              <div class="col-md-6 col-xl-3">
                                   <a href="{{ route('order-cancel') }}" style="text-decoration: none;">
                                        <div class="card cursor-pointer">
                                             <div class="card-body">
                                                  <div class="d-flex align-items-center justify-content-between">
                                                       <div>
                              ...
                              <div class="col-md-6 col-xl-3">
                                   <a href="{{ route('order-delivered') }}" style="text-decoration: none;">
                                        <div class="card cursor-pointer">
                                             <div class="card-body">
                                                  <div class="d-flex align-items-center justify-content-between">
                                                       <div>
